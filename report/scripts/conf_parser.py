            ...
            yaml.dump(
                {
                    ...
                    "teacher": conf["metadata"]["general"]["teacher"] if "teacher" in conf["metadata"]["general"] else None,
                    "author": conf["metadata"]["general"]["author"] if "author" in conf["metadata"]["general"] else None,
                    "group": conf["metadata"]["general"]["group"] if "group" in conf["metadata"]["general"] else None,
                    ...
                    "link-citations": conf["metadata"]["general"]["link-citations"] if "link-citations" in conf["metadata"]["general"] else None,
